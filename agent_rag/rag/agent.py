...
class RAGAgentReact:
    ...
    def __init__(self, openai_api_key: str = None):
        ...
        # Criar AgentExecutor (sem early_stopping_method)
    ...
    def _create_tools(self) -> List[Tool]:
        ...
        return [
            Tool(
                ...
                description="""Use esta ferramenta para consultar informações sobre diversos assuntos.
                Esta é a ferramenta principal para buscar informações na base de conhecimento.
                
                Input: Uma pergunta ou consulta sobre qualquer assunto
...
- Mantenha o foco em temas relevantes para a pergunta  
...
Thought: {agent_scratchpad}"""
    ...
    def _busca_especifica(self, termos: str) -> str:
        ...
        try:
            ...
            query_especifica = f"Informações específicas sobre {termos}"
    ...
    def run_interactive(self):
        ...
        print("=== Agente ReAct - Sistema de Consulta ===")
