...
class RAGSystem:
    """Sistema RAG para consultas sobre a economia do Estado de São Paulo."""
    
    def __init__(self, chroma_path: str = "chroma_db", collection_name: str = "seade_gecon"):
        """
...
Você é um assistente especializado em economia do setor automotivo do estado de São Paulo.
...
"""
    ...
    def interactive_session(self) -> None:
        ...
        print("=== Sistema RAG - Economia do Setor Automotivo de São Paulo ===")
        print("Digite 'sair' para encerrar o programa\n")
        
        while True:
            try:
                user_input = input("Qual é a sua dúvida sobre a economia do Estado de São Paulo?\n> ").strip()
